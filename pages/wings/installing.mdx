...
![example image of wings configuration](public/wings_configuration_example.png)

<Callout type='warning'>
    When your Panel is using SSL, the Wings must also have one created for its FQDN. See [Creating SSL Certificates](/tutorials/creating-ssl-certificates) documentation page for how to create these certificates before continuing.
</Callout>
...
![example image of node allocations](pages/public/node_allocations.png)
