...
our [PHP Upgrade Guide](/guides/php-upgrade) and return to this documentation afterward.
...
<Tabs items={['NGINX or Apache', 'NGINX on CentOS', 'Apache on CentOS']} defaultindex='1'>
    <Tab>
        ```bash copy
